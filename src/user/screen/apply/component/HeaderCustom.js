        ...
        return (
            <View>
                ...
                <TouchableOpacity
                    ...
                    <Text style={[styles.text, { color: type === item.label ? Colors.background : 'black' }]}>{item.label}</Text>
                </TouchableOpacity>
            </View>
        );
    };
...
const styles = StyleSheet.create({
    ...
    touchable: { width: 100, height: 32, alignItems: 'center', justifyContent: "center" },
    line: {
        width: 100,
        height: 1,
