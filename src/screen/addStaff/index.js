...
import {InputInfor, Button, InputSelect, TextSelect} from '../../component';
import {
  StyleSheet,
  Text,
  View,
          ...
          <View style={styles.modalview}>
            ...
            <ScrollView>
              <TextSelect
                title={'App'}
                onPressButton={() => {
                  setDetailPosition('Team App'), setModalPosition(!Modal);
                }}
              ...
              <TextSelect
                title={'HR'}
                onPressButton={() => {
                  setDetailPosition('Team HR'), setModalPosition(!Modal);
                }}
              ...
              <TextSelect
                title={'Tester'}
                onPressButton={() => {
                  setDetailPosition('Team Tester'), setModalPosition(!Modal);
                }}
              ...
              <TextSelect
                title={'OS'}
                onPressButton={() => {
                  setDetailPosition('Team OS'), setModalPosition(!Modal);
                }}
              ...
              <TextSelect
                title={'Firmware'}
                onPressButton={() => {
                  setDetailPosition('Team Firm-ware'), setModalPosition(!Modal);
                }}
              ...
              <TextSelect
                title={'Back-end'}
                onPressButton={() => {
                  setDetailPosition('Team Back-end'), setModalPosition(!Modal);
                }}
              ...
              <TextSelect
                title={'Khác'}
                onPressButton={() => {
                  setDetailPosition('Team Khác'), setModalPosition(!Modal);
                }}
