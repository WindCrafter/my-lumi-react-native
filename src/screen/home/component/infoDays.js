  ...
  return (
    <>
      <View style={styles.manager}>
        <Text style={styles.txtManager}>Tổng quan/ ngày</Text>
      </View>
      <View style={styles.bot}>
        <View styles={styles.comp}>
          <Text style={styles.onTime}> 0</Text>
          <Text style={styles.txtOnTime}> Đúng giờ</Text>
        </View>
        <View styles={styles.comp}>
          <Text style={styles.late}> 1</Text>
          <Text style={styles.txtLate}> Đi Muộn</Text>
        </View>
        <View styles={styles.comp}>
          <Text style={styles.break}> 2</Text>
          <Text style={styles.txtBreak}> Nghỉ làm</Text>
        </View>
      </View>
    </>
  );
