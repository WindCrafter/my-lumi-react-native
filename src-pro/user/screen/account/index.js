      ...
      <View style={styles.container}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={{ alignSelf: 'center', paddingVertical: 10 }}>
            {
              codepush.progress === 0 ? <Text>V1.1.0</Text> : codepush.progress === 100 ? <TouchableOpacity onPress={restartApp}><Text>Cần khởi động lại</Text></TouchableOpacity> : <Text>{codepush.progress}</Text>
            }
          </View>
        </ScrollView>
        <ModalInforApp
